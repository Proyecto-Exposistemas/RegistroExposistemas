...
<?php
  ...
  function insertarDatos(){
    ...
    /* Lee los datos que se encuentran en listaRfcAsesoresPhp y en listaNumerosExponentesPhp*/
    $listaRfcAsesoresPhp = $_POST['listaRfcAsesoresPhp'];
    $listaNumerosExponentesPhp = $_POST['listaNumerosExponentesPhp'];
